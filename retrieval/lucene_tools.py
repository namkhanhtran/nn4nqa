...
class Lucene(object):
    ...
    def __init__(self, index_dir, max_shingle_size=None, lucene_vm_init=False):
...
class LuceneDocumentField(object):
    ...
    def __init__(self):
        ...
        self.field_text_ntvp.setIndexOptions(IndexOptions.DOCS_AND_FREQS_AND_POSITIONS)
